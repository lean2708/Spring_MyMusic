# Spring My Music
Spring MyMusic is an online music listening website built with Spring Boot
## Tech Stack
...
**1. Clone Repository :**
```java
git clone https://github.com/lean2708/Spring_MyMusic.git
cd Spring_MyMusic
```
...
```java
http://localhost:8080/mymusic/swagger-ui/index.html
```
- The default URL to retrieve the API documentation in JSON format **(Explore section)**:
```java
/mymusic/v3/api-docs/backend-service
```
